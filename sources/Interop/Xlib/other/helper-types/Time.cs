...
{
    public unsafe partial struct Time : IComparable, IComparable<Time>, IEquatable<Time>, IFormattable
    {
        ...
        public static explicit operator Time(byte value) => new Time((void*)(value));

        public static explicit operator byte(Time value) => (byte)(value.Value);

        public static explicit operator Time(short value) => new Time((void*)(value));

        public static explicit operator short(Time value) => (short)(value.Value);

        public static explicit operator Time(int value) => new Time((void*)(value));

        public static explicit operator int(Time value) => (int)(value.Value);

        public static explicit operator Time(long value) => new Time((void*)(value));

        public static explicit operator long(Time value) => (long)(value.Value);

        public static explicit operator Time(nint value) => new Time((void*)(value));

        public static implicit operator nint(Time value) => (nint)(value.Value);

        public static explicit operator Time(sbyte value) => new Time((void*)(value));

        public static explicit operator sbyte(Time value) => (sbyte)(value.Value);

        public static explicit operator Time(ushort value) => new Time((void*)(value));

        public static explicit operator ushort(Time value) => (ushort)(value.Value);

        public static explicit operator Time(uint value) => new Time((void*)(value));

        public static explicit operator uint(Time value) => (uint)(value.Value);

        public static explicit operator Time(ulong value) => new Time((void*)(value));

        public static explicit operator ulong(Time value) => (ulong)(value.Value);

        public static explicit operator Time(nuint value) => new Time((void*)(value));
